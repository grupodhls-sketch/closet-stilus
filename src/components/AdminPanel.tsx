...
export function AdminPanel() {
  ...
  const startEdit = (p: Product) => { setEditingId(p.id); setEditData({ ...p }); };
  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed top-4 right-4 md:top-5 md:right-5 z-[70] w-10 h-10 md:w-11 md:h-11 rounded-full bg-white/80 backdrop-blur-xl border border-lavanda/30 shadow-[0_4px_20px_rgba(126,88,184,0.15)] flex items-center justify-center text-cinza-texto hover:text-roxo hover:border-roxo/40 transition-colors duration-300"
        ...
        {loginOpen && (
          ...
          >
            ...
            >
              ...
              <p className="text-cinza-texto/40 text-[11px] text-center mt-4 sm:mt-5">admin / stilus2026</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
              ...
              <div className="px-4 pt-4 pb-3 border-b border-lavanda/10 bg-gradient-to-r from-white to-lavanda/5 shrink-0">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button onClick={() => { logout(); setPanelOpen(false); }}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-off-white rounded-2xl p-4 border border-lavanda/10">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {sales.length > 0 && (
                          <button onClick={() => { if (confirm("Limpar histórico de vendas?")) { clearSales(); showToast("Histórico limpo!"); } }}
